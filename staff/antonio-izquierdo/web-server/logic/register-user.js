const fs = require('fs')
const { validateEmail, validatePassword, validateCallback, validateFullname, validateRepeatedPassword } = require('./helpers/validations')
        ...
        fs.readdir(usersPath, (error, files) => {
            ...
            (function check(files, index = 0) {
                if (index < files.length) {
                    ...
                    const user = { id, fullname, email, password, repassword }
