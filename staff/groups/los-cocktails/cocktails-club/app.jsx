  ...
  render() {
    ...
    return (
      <>
        ...
        {view === "access" && (
          <Access onRegister={handleGoToRegister} onLogin={handleGoToLogin} />
        )}

        {view === "register" && (
          <Register
            onRegisterSuccess={handleGoToHome}
            returnToLogin={handleGoToLogin}
          />
        )}
        ...
        {view === "login" && (
          <Login
            ...
            returnToRegister={handleGoToRegister}
          />
        )}
