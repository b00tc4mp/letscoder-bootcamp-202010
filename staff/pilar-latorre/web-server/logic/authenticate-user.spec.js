...
const { randomStringWithPrefix, randomWithPrefixAndSuffix, randomNonString, randomEmptyOrBlankString, randomNonFunction } = require('../utils/randoms')
const fs = require('fs')
...
describe('authenticateUser()', () => {
    describe('when user already exists', () => {
     ...
     describe('when wrong credential', () => {
    ...
    describe('when any parameter is wrong', () => {
        describe('when e-mail is wrong', () => {
            ...
            describe('when e-mail is empty or blanck', () => {
                let email, password
                ...
                it('should fail on empty or blanck email', () => {
        ...
        describe('when password is wrong', () => {
            ...
            describe('when password is empty or blank', () => {
                ...
                it('should fail on empty or blanck password', () => {
        ...
        describe('when callback is not a function', () => {
            ...
            it('should fail on a non fuction callback', () => {
