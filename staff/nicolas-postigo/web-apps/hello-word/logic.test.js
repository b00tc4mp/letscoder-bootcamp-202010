...
(function () {
    ...
    registerUser(fullname, email, password, repassword)
    var user = user.find(function(user){return user.email === email})
    console.assert(user.email === email, "should email matched")
    console.assert(user.fullname === fullname, "should fullname match")
    console.assert(user.password === repassword, "should password matched")
})();
