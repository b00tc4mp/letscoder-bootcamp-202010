...
function Createoffer({ backHub, offername, titleoffer, onCreateoffer, image }) {
    return <sections>
        ...
        <form className="offer__form" onSubmit={function (event) {
            ...
            const { target: { offername: { value: offername }, titleoffer: { value: titleoffer }, image: { value: image } } } = event


            onCreateoffer(offername, titleoffer, image)
        }}>
