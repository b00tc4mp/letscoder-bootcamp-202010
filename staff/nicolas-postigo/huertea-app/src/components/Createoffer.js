...
function Createoffer({ backHub, offername, titleoffer, onCreateoffer, image, price }) {
    return <sections>
        ...
        <form className="offer__form" onSubmit={function (event) {
            ...
            const { target: { offername: { value: offername }, titleoffer: { value: titleoffer }, image: { value: image }, price: { value: price } } } = event


            onCreateoffer(offername, titleoffer, image, price)
        }}>
