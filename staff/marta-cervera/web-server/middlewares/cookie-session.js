...
module.exports = (req, res, next) => {
    ...
    res.setHeader('set-cookie', createSessionCookie(id)) //response te mando este cabcero, esta cabecero es un metodo


    const session = new Session(id) /// es instancia de sesion va a heredar los metodos
