(function () {
    ...
    (function () {
      ...
      console.assert(
        fail.message === fullname + " is not a full name",
        "should error message match expected"
      );
    })();
    ...
    (function () {
      ...
      console.assert(
        fail.message === "full name is empty or blank",
        "should error message match expected"
      );
    })();
    ...
    (function () {
      ...
      console.assert(
        fail.message === email + " is not an e-mail",
        "should error message match expected"
      );
    })();
    ...
    (function () {
      ...
      console.assert(
        fail.message === "e-mail is empty or blank",
        "should error message match expected"
      );
    })();
    ...
    (function () {
      ...
      console.assert(
        fail.message === repassword + " is not a password repeat",
        "should error message match expected"
      );
    })();
    ...
    (function () {
      ...
      console.assert(
        fail.message === "password repeat is empty or blank",
        "should error message match expected"
      );
    })();
    ...
    (function () {
      ...
      console.assert(
        fail.message === "passwords don't match",
        "should error message match expected"
      );
    })();
