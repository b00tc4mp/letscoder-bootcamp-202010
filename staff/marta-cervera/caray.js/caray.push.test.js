...
console.assert(c.length === 4, "caray should be 4")

console.assert(c[0] === v1, "index 0 is not working properly")
console.assert(c[1] === v2, "index 1 is not working properly")
console.assert(c[2] === v3, "index 3 is not working properly")
console.assert(c[3] === v4, "index 3 is not working properly")
