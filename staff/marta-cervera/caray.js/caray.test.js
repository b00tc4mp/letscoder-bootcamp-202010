...
(function(){
    console.log( " should create a Caray of length more than one argument it receives some arguments ")
 var c = new Caray(10, "pepito")

 console.assert(c.length===2, "length of c should be 2")
})();

(function(){
    console.log( "should create a Caray in which items will be 10 and pepito")
   
    var c = new Caray(10, "pepito")
    console.assert(c[0]= 10)
    console.assert(c[1]= "pepito")
