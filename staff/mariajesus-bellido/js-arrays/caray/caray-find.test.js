...
(function(){
    ...
    var number = new Caray (50, 159, 390, 1101, 25); 
    ...
    console.assert(result === 159, "should the result be 159"); 
    console.assert(result.length === undefined, "should the result length be undefined"); 
    console.assert(!(result)<1000, "should the result be bigger than 1000");
    console.assert(number.length === 5, "should be number length be 5"); 
...
var numbers = new Caray (Math.random(), Math.random(), Math.random(), Math.random(), Math.random());
...
console.assert(result.length === underfined, "should result length undefined"); 
console.assert(result < 0.5, "should the result be lower than 0.5"); 
})(); 

(function(){

console.log("should throw and error if callback is not a function"); 
...
console.assert(fail.message === "12 is not a function", "the rror message is not correct");
