...
(function() {
    ...
    console.assert(c[0] === v1, 'should index 0 point to random number between 0 to 0.99999')
    console.assert(c[1] === v2, 'should index 1 point to random letter from "a" to "f"')
    console.assert(c[2] === v3, 'should index 2 point to a boolean value')
    console.assert(c[3] === v4, 'should index 3 point to a null or undefined value')
})();