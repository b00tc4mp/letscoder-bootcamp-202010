...
document.getElementById("float-button").addEventListener("click", floatButton);
...
function floatButton() {
    var firstValue = document.getElementById("result").innerHTML;
    var secondValue = document.getElementById("float-button").innerHTML;
    document.getElementById("result").innerHTML = firstValue + secondValue;
...
function showResult (){
    ...
    if (addition !== -1) {
        ...
        res = parseFloat(arr[0]) + parseFloat(arr[1]);  //Función parseFloat devuelve flotantes de arr[0, 1], hacemos operación aritmética y guardamos en res.
