...
export default function Workouts({onChosenLevel}) {
    ...
    return <section className="workout">
        ...
        <h3 className="workout__title"> ¿Cuál es tu nivel?</h3>
        <div onClick={() => onChosenLevel("beginner")} className="workout__level">
            <h4 className="workout__level-title"> Principiante </h4>
            <p className="workout__level-description"> 
        ...
        <div onClick={() => onChosenLevel("intermediate")} className="workout__level">
            <h4 className="workout__level-title"> Intermedio </h4>
            <p className="workout__level-description"> 
        ...
        <div onClick={() => onChosenLevel("advanced")} className="workout__level">
            <h4 className="workout__level-title"> Avanzado </h4>
            <p className="workout__level-description"> Elige este nivel si tienes una experiencia mínima de <span className="bold">3-5 años de entrenamiento</span> serio,
