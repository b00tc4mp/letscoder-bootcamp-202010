...
const caloriesCalc = (man, woman, goal, weight, height, age, activity, callback) => {

    if (man === 'man' && man !== undefined && goal) {
    ...
    else if (woman === 'woman' && woman !== undefined && goal) {
...
caloriesCalc('man', undefined, 'maintain', 62, 168, 34, 'athlete', console.log)