(function () {
    ...
    (function () {
        ...
        var fullname = 'John Doe ' + Math.random()
        var email = ['john-doe#mail.com', '@mail.com', 'john-doe@mail', 'john-doe@', 'john-doe.com'].random()
        var password = 'pass-' + Math.random()
        var repassword = password
...
(function () {
    ...
    registerUser(fullname, email, password, repassword)
    var user = users.find(function(user){return user.email === email})
    console.assert(user.email === email, 'e-mail should match' )
    console.assert(user.fullname === fullname, 'fullname should match')
    console.assert(user.password === repassword, 'password should match')
    ...
    (function(){
       ...
       var login = authenticateUser(email,password)
       console.assert (login.email === email) 
       console.assert (login.password === password)
