...
const Carta = () => {
    ...
    //         {products && <div className="carta__container">
    //             {products.map( ({name, description, price}) => <div className="carta__item carta__item--2">
    //                 <div className="carta__description">
    //                     <h4 className="carta__h4">{name}</h4>
    //                     <p className="carta__p">{description}, <span>{price}</span></p>
    //                 </div>
