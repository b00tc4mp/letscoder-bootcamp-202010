...
(function (){
console.log (" Should create a Caray of a length bigger than 1 when it receives several arguments")
    ...
    console.assert(c.length > 1, "should length de bigger than 1");
    for (var i=0; i < c.length; i++){
